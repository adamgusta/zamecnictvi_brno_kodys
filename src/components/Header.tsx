        ...
        <div className="flex items-center justify-between h-20 py-4">
          ...
          <nav className="hidden lg:flex items-center gap-7">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="text-slate-300 hover:text-amber-400 text-sm font-semibold transition-colors relative after:absolute after:bottom-[-4px] after:left-1/2 after:w-0 after:h-0.5 after:bg-amber-500 hover:after:w-full hover:after:left-0 after:transition-all after:duration-300"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            <a
              ...
              className="flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-slate-900 font-bold px-4 py-2.5 rounded-xl text-sm transition-all hover:shadow-lg hover:shadow-amber-500/20 hover:-translate-y-0.5 animate-pulse-gold"
            >
      ...
      {menuOpen && (
        <div className="lg:hidden bg-slate-950 border-t border-slate-850 px-4 pb-6 pt-4 shadow-xl animate-in fade-in slide-in-from-top duration-200">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              href="tel:+420777818339"
              className="flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-400 text-slate-900 font-bold px-4 py-3 rounded-xl transition-colors shadow-lg shadow-amber-500/10 animate-pulse-gold"
            >
              <Phone className="w-4 h-4" />
